...
//    public static final KeyStroke COLLAPSE_ALL      = KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, CONTROL_MASK);
    public static final KeyStroke ZOOM_OUT      = KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, CONTROL_MASK);
    public static final KeyStroke ZOOM_IN      = KeyStroke.getKeyStroke(KeyEvent.VK_PLUS, CONTROL_MASK);
